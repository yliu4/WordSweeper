...
/**
 * Controller on server to package up the current state of the model as an
 * updateResponse message and send it back to the client.
 */
public class CreateGameRequestController implements IProtocolHandler {
	...
	public Message process(ClientState client, Message request) {
		...
		String xmlString = Message.responseHeader(request.id())
				+ "<boardResponse gameId='hg12jhd' managingUser='"
				+ pname
				+ "' bonus='4,3' contents='ABCGBCJDH...HDJHJD'>"
				+ "<player name='"
				+ pname
				+ "' score='392489038' position='4,6' board='AFERKSOEROIERPOR'/>"
