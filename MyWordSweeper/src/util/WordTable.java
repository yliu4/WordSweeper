...
public class WordTable {
	...
	/**
	 * Load up word table. Note that there may be superfluous spaces throughout
	 * for formatting reasons, and these are excised before being added to the
	 * table.
	 * 
	 * @throws IOException
	 ...
	 * 
	 * @param s
	 * @return <code>true</code> if a word in the table; <code>false</code>
	 *         otherwise.
	 */
