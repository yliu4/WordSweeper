...
public class BoardPanel extends JPanel {
	...
	public BoardPanel(Model model, ArrayList<Cell> cells) {
		...
		int height = d.height;
		int width = d.width;
		setBounds(height / 36, 17 * width / 160, 13 * height / 45,
				13 * width / 80);
	...
	public void paintComponent(Graphics g) {
		...
		g.drawLine(0, 52 * width / 320 - 1, 13 * height / 45,
				13 * width / 80 - 1);
		...
		g.drawLine(52 * height / 180 - 1, 0, 13 * height / 45 - 1,
				13 * width / 80);
		...
		this.cells.get(0).setCoordinateLocation(0, 0, 13 * height / 180,
				13 * width / 320);
		this.cells.get(1).setCoordinateLocation(13 * height / 180, 0,
				13 * height / 180, 13 * width / 320);
		this.cells.get(2).setCoordinateLocation(26 * height / 180, 0,
				13 * height / 180, 13 * width / 320);
		this.cells.get(3).setCoordinateLocation(39 * height / 180, 0,
				13 * height / 180, 13 * width / 320);
		this.cells.get(4).setCoordinateLocation(0, 13 * width / 320,
				13 * height / 180, 13 * width / 320);
		this.cells.get(5).setCoordinateLocation(13 * height / 180,
				13 * width / 320, 13 * height / 180, 13 * width / 320);
		this.cells.get(6).setCoordinateLocation(26 * height / 180,
				13 * width / 320, 13 * height / 180, 13 * width / 320);
		this.cells.get(7).setCoordinateLocation(39 * height / 180,
				13 * width / 320, 13 * height / 180, 13 * width / 320);
		this.cells.get(8).setCoordinateLocation(0, 26 * width / 320,
				13 * height / 180, 13 * width / 320);
		this.cells.get(9).setCoordinateLocation(13 * height / 180,
				26 * width / 320, 13 * height / 180, 13 * width / 320);
		this.cells.get(10).setCoordinateLocation(26 * height / 180,
				26 * width / 320, 13 * height / 180, 13 * width / 320);
		this.cells.get(11).setCoordinateLocation(39 * height / 180,
				26 * width / 320, 13 * height / 180, 13 * width / 320);
		this.cells.get(12).setCoordinateLocation(0, 39 * width / 320,
				13 * height / 180, 13 * width / 320);
		this.cells.get(13).setCoordinateLocation(13 * height / 180,
				39 * width / 320, 13 * height / 180, 13 * width / 320);
		this.cells.get(14).setCoordinateLocation(26 * height / 180,
				39 * width / 320, 13 * height / 180, 13 * width / 320);
		this.cells.get(15).setCoordinateLocation(39 * height / 180,
				39 * width / 320, 13 * height / 180, 13 * width / 320);
		...
		if (location != null) {
			...
			for (int i = 0; i < 16; i++) {
				...
				if (x + dragWidth >= cellLoc.CoordinateX
						&& x + dragWidth <= cellLoc.CoordinateX + cellLoc.width
						&& y + dragHeight >= cellLoc.CoordinateY
						&& y + dragHeight <= cellLoc.CoordinateY
								+ cellLoc.height)
					set.add(i);
			}
			...
			for (Integer num : set) {
				...
				g.fillRect(cell.CoordinateX, cell.CoordinateY, cell.width,
						cell.height);
			}
